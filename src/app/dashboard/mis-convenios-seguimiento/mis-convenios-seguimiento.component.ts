...
@Component({
  selector: 'app-mis-convenios-seguimiento',
  templateUrl: './mis-convenios-seguimiento.component.html',
  styleUrls: ['./mis-convenios-seguimiento.component.css']
})
export class MisConveniosSeguimientoComponent implements OnInit {
  sesion: any;
